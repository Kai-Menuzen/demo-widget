...
function Signagelive() {
    try {
        ...
        self.getExternalData = function (dataSource, integrationId, integrationName, onDataUpdate) {
            // Store callback for data updates
            var uniqueIntegrationId = getUniqueIntegrationId(dataSource, integrationId, integrationName);
        ...
        function getUniqueIntegrationId(dataSource, integrationId, integrationName) {
            return (dataSource + '-' + integrationId + '-' + integrationName.replace(/\s/g, '_')).toLowerCase();
        }
